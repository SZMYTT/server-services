...
Controls how long the agent runs, how much content it reads per page,
how many sources it gathers, and how the LLM is instructed to behave.

Depth affects:
  - max_iterations  : max LLM tool-call rounds (vendor agent)
...
def choices() -> list[tuple[str, str, int]]:
    """Returns list of (key, label, est_minutes) for UI dropdowns."""
